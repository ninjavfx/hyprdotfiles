...
USER_INFO_THEME_PROMPT_COLOR=110
...
PYTHON_VENV_THEME_PROMPT_COLOR=61
...
SCM_THEME_PROMPT_DIRTY_COLOR=93
...
CWD_THEME_PROMPT_COLOR=110

LAST_STATUS_THEME_PROMPT_COLOR=196

CLOCK_THEME_PROMPT_COLOR=61
...
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="user_info clock scm python_venv cwd"}
